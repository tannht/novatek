        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <div class="btn-group mr-1 mt-2">
                        <button type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Light <i class="mdi mdi-chevron-down"></i></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
                            <a class="dropdown-item" href="#">Something else here</a>
            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <div class="btn-group mt-2 mr-1 dropright">
                        ...
                        <button type="button" class="btn btn-light waves-effect waves-light dropdown-toggle-split dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
