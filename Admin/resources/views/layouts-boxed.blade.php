...
@component('components.breadcrumb')                
    ...
    @slot('li_2') Boxed Layout @endslot
@endcomponent
                            ...
                            <tbody>
                                    ...
                                    <td style="width: 60px;">
                                        <div class="avatar-xs">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <img src="{{ URL::asset('/assets/images/companies/img-1.png')}}" alt="" height="20">
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-xs">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <img src="{{ URL::asset('/assets/images/companies/img-2.png')}}" alt="" height="20">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-xs">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <img src="{{ URL::asset('/assets/images/companies/img-3.png')}}" alt="" height="20">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
