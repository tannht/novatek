    ...
    <div class="col-12">
        ...
        <div class="email-leftbar card">
            ...
            <div class="mail-list mt-1">
                <a href="#"><span class="mdi mdi-circle-outline text-info float-right"></span>Theme Support</a>
                <a href="#"><span class="mdi mdi-circle-outline text-warning float-right"></span>Freelance</a>
                <a href="#"><span class="mdi mdi-circle-outline text-primary float-right"></span>Social</a>
                <a href="#"><span class="mdi mdi-circle-outline text-danger float-right"></span>Friends</a>
                <a href="#"><span class="mdi mdi-circle-outline text-success float-right"></span>Family</a>
            </div>
            ...
            <div class="mt-2">
                <a href="#" class="media">
                    <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-2.jpg')}}" alt="Generic placeholder image" height="36">
                ...
                <a href="#" class="media">
                    <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-3.jpg')}}" alt="Generic placeholder image" height="36">
                    <div class="media-body chat-user-box overflow-hidden">
                ...
                <a href="#" class="media">
                    <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-4.jpg')}}" alt="Generic placeholder image" height="36">
                    <div class="media-body chat-user-box overflow-hidden">
                ...
                <a href="#" class="media">
                    <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-6.jpg')}}" alt="Generic placeholder image" height="36">
                    <div class="media-body chat-user-box overflow-hidden">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="media mb-4">
                        <img class="d-flex mr-3 rounded-circle avatar-sm" src="{{ URL::asset('/assets/images/users/avatar-2.jpg')}}" alt="Generic placeholder image">
