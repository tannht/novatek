        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="media mb-4">
                    <img class="avatar-sm mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-6.jpg')}}" alt="">
                ...
                <div class="media mb-4">
                    <img class="avatar-sm mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-2.jpg')}}" alt="">
                    <div class="media-body">
                        <h5 class="mt-0 font-size-14">Media heading</h5>
                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                ...
                <div class="media">
                    <div class="media-body">
                        <h5 class="mt-0 mb-1 font-size-14">Media object</h5>
                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                    </div>
                    <img class="avatar-sm ml-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-4.jpg')}}" alt="">
                </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="media mb-4">
                    <img class="avatar-sm align-self-start rounded mr-3" src="{{ URL::asset('/assets/images/users/avatar-3.jpg')}}" alt="">
                    <div class="media-body">
                ...
                <div class="media mb-4">
                    <img class="avatar-sm align-self-center rounded mr-3" src="{{ URL::asset('/assets/images/users/avatar-5.jpg')}}" alt="">
                    <div class="media-body">
                ...
                <div class="media">
                    <img class="avatar-sm align-self-end rounded mr-3" src="{{ URL::asset('/assets/images/users/avatar-1.jpg')}}" alt="">
                    <div class="media-body">
